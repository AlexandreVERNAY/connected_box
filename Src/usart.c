...
//	[7.4.1]GPIO port mode register
	GPIOA->MODER |= (ALTERN_MODE << GPIO_MODER_MODER2_Pos);	// Set Alternate Function mode for PA2
	GPIOA->MODER |= (ALTERN_MODE << GPIO_MODER_MODER3_Pos);	// Set Alternate Function mode for PA3

//	[7.4.9]GPIO alternate function low register
	GPIOA->AFR[0] |= (GPIO_AFR7 << GPIO_AFRL_AFSEL2_Pos);	// Set Alternate Function Port 7 for PA2
	GPIOA->AFR[0] |= (GPIO_AFR7 << GPIO_AFRL_AFSEL3_Pos);	// Set Alternate Function Port 7 for PA3
...
//	[25.6.4]Control register 1
	...
	USART2->CR1 |= USART_CR1_RXNEIE;			// Enable Interrupt for data reception
...
//	[7.4.9]GPIO alternate function low register
	GPIOA->AFR[0] |= (GPIO_AFR8 << GPIO_AFRL_AFSEL0_Pos);	// Set Alternate Function Port 8 for PA0
	GPIOA->AFR[0] |= (GPIO_AFR8 << GPIO_AFRL_AFSEL1_Pos);	// Set Alternate Function Port 8 for PA1
